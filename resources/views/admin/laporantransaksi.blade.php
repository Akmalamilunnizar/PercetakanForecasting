...
@section('page_title')
CIME | Halaman Laporan Transaksi
@endsection
@section('search')
...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card">
        <h5 class="card-header fw-bold">Data Laporan Transaksi</h5>
                ...
                <table class="table table-striped">
                   <thead class="table-primary">
                    <tr>
                        ...
                        <th style="text-align: center; font-weight: bold;">Total Harga</th>
                    ...
                    @if($laporantransaksi->count() > 0)
                        @foreach ($laporantransaksi as $laporan)
                            <tr>
                                ...
                                <td class="text-center">{{ optional($laporan->produk)->NamaProduk }}</td>
